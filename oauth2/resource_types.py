...
class AiohttpDynamicResource (web.DynamicResource, _ResourceMixin):
    def __init__(self, path, *, name=None, name_for=None):
        # language=rst
        ...
        **Rationale**
        ...
        self._name_for = name_for or (name and "{%s}" % name) or name
